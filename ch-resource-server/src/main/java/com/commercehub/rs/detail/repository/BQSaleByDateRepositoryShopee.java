...
import com.commercehub.rs.core.repository.SaleByDateRepository;
...
@Dependent
public class BQSaleByDateRepositoryShopee implements SaleByDateRepository {
    ...
    @Override
    public List<SaleByDate> execute(GetSaleInput input) {
