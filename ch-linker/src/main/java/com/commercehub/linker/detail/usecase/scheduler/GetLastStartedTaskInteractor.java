...
import com.commercehub.linker.core.usecase.scheduler.GetLastStartedTask;

import javax.enterprise.context.Dependent;
import java.util.List;

@Dependent
public class GetLastStartedTaskInteractor implements GetLastStartedTask {

    private final TimedTaskRepository repository;

    public GetLastStartedTaskInteractor(TimedTaskRepository repository) {
        this.repository = repository;
    }

    @Override
    public List<TimedTask> execute(String taskGroup, String shopId, int noOfRecord) {
        return repository.getLastStarted(taskGroup, shopId, noOfRecord);
    }
