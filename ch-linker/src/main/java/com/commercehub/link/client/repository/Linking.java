...
public class Linking {
    ...
    public Linking(String status, String platform, String partnerId, String partnerSecret, String shopId, String shopName, String shopStatus, String shopRegion, String accessToken, Date accessTokenExpiry, String refreshToken, Date refreshTokenExpiry, boolean link, boolean setup, Date businessStartDate) {
        this.status = status;
