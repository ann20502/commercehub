...
public class ItemBuilder {
    ...
    private Order.ImageInfo imageInfo;
    ...
    public ItemBuilder setImageInfo(Order.ImageInfo imageInfo) {
        this.imageInfo = imageInfo;
        return this;
    }

    public Order.Item createItem() {
        return new Order.Item(id, name, sku, modelId, modelName, modelSku, modelQuantityPurchased, modelOriginalPrice, modelDiscountedPrice, wholesale, weight, addOnDeal, mainItem, addOnDealId, promotionType, promotionId, orderItemId, promotionGroupId, imageInfo);
    }
}