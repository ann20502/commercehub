...
public class RecipientAddressBuilder {
    ...
    public BQOrderShopee.RecipientAddress createRecipientAddress() {
        return new BQOrderShopee.RecipientAddress(name, phone, town, district, city, state, region, zipcode, fullAddress);
    }
}