...
public class BQOrderShopee {
    ...
    public final BQOrderShopee.RecipientAddress recipientAddress;
    ...
    @Json(name = "items")
    public final List<BQOrderShopee.Item> items;
    ...
    public final BQOrderShopee.Invoice invoice;
    ...
    @Json(name = "escrow")
    public final BQOrderShopee.Escrow escrow;

    public BQOrderShopee(String orderSn, String region, String currency, boolean cod, BigDecimal totalAmount, String orderStatus, String shippingCarrier, String paymentMethod, BigDecimal estimatedShippingFee, String messageToSeller, Instant createTime, Instant updateTime, Instant extractTime, int daysToShip, Instant shipByDate, long buyerUserId, String buyerUsername, BQOrderShopee.RecipientAddress recipientAddress, BigDecimal actualShippingFee, boolean goodsToDeclare, String sellerNote, Instant sellerNoteUpdateTime, List<BQOrderShopee.Item> items, Instant payTime, String dropshipper, String dropshipperPhone, boolean splitUp, String buyerCancelReason, String cancelBy, String cancelReason, boolean actualShippingFeeConfirmed, String fulfillmentFlag, Instant pickupDoneTime, BQOrderShopee.Invoice invoice, String checkoutShippingCarrier, BigDecimal reverseShippingFee, BQOrderShopee.Escrow escrow) {
