...
public class BQItemShopee {
    ...
    public final List<BQItemShopee.Attribute> attributes;

    @Json(name = "prices")
    public final List<BQItemShopee.Price> prices;

    @Json(name = "image")
    public final BQItemShopee.Image image;

    @Json(name = "weight")
    public final String weight;

    @Json(name = "dimension")
    public final BQItemShopee.Dimension dimension;

    @Json(name = "pre_order")
    public final BQItemShopee.PreOrder preOrder;

    @Json(name = "wholesales")
    public final List<BQItemShopee.Wholesale> wholesales;
    ...
    public static class Attribute {
        ...
        public List<BQItemShopee.AttributeValue> attributeValues;

        public Attribute(long attributeId, String originalAttributeName, boolean is_mandatory, List<BQItemShopee.AttributeValue> attributeValues) {
