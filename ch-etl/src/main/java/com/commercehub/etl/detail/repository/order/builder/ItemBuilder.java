...
public class ItemBuilder {
    ...
    private BQOrderShopee.ImageInfo imageInfo;
    ...
    public ItemBuilder setImageInfo(BQOrderShopee.ImageInfo imageInfo) {
        this.imageInfo = imageInfo;
        return this;
    }

    public BQOrderShopee.Item createItem() {
        return new BQOrderShopee.Item(id, name, sku, modelId, modelName, modelSku, modelQuantityPurchased, modelOriginalPrice, modelDiscountedPrice, wholesale, weight, addOnDeal, mainItem, addOnDealId, promotionType, promotionId, orderItemId, promotionGroupId, imageInfo);
    }
}